...
<script type="text/javascript">
	var table = $('#data-table').DataTable({
		"data": null,
		"ajax": {
			"url": "http://localhost/project1ku/admin/getadmin",
			"type": "GET"
		},
	});
	...
	$('#button-add').on('click', function(e) {
		...
		if (operasi == 'update') {
			$.ajax({
				url: 'http://localhost/project1ku/admin/updateadmin?id=' + idadmin,
				data: AddAdmin,
				type: 'POST',
				dataType: 'json',
				success: function(dt) {
			...
			$.ajax({
				url: 'http://localhost/project1ku/admin/addadmin',
				data: AddAdmin,
				type: 'POST',
				dataType: 'json',
				success: function(dt) {
	...
	function EditAdmin(id) {
		$.ajax({
			url: 'http://localhost/project1ku/admin/getadminid?id='+id,
			type: 'GET',
			dataType: 'json',
			success: function(dt) {
	...
	$('#button-delete').on('click', function() {
		id = $('#iddelete').val();
		$.ajax({
			url: 'http://localhost/project1ku/admin/deleteadmin?id='+id,
			type: 'GET',
			dataType: 'json',
			success: function(dt) {
