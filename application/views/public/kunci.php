...
<script type="text/javascript">
	var table = $('#data-table').DataTable({
		"data": null,
		"ajax": {
			"url": "http://localhost/project1ku/kunci/getkunci",
			"type": "GET"
		},
	});
	...
	$('#button-add').on('click', function(e) {
		...
		if (operasi == 'update') {
			$.ajax({
				url: 'http://localhost/project1ku/kunci/updatekunci?id=' + idkunci,
				data: AddKunci,
				type: 'POST',
				dataType: 'json',
				success: function(dt) {
			...
			$.ajax({
				url: 'http://localhost/project1ku/kunci/addkunci',
				data: AddKunci,
				type: 'POST',
				dataType: 'json',
				success: function(dt) {
	...
	function EditKunci(id) {
		$.ajax({
			url: 'http://localhost/project1ku/kunci/getkunciid?id='+id,
			type: 'GET',
			dataType: 'json',
			success: function(dt) {
	...
	$('#button-delete').on('click', function() {
		id = $('#iddelete').val();
		$.ajax({
			url: 'http://localhost/project1ku/kunci/deletekunci?id='+id,
			type: 'GET',
			dataType: 'json',
			success: function(dt) {
